...
public class DetalleDeFactura {
    public static void main(String[] args) {
        ...
        String mensajeFinal = "La factura: " + nombreFactura + " tiene un total bruto de: " + totalBruto + ", con un impuesto de: " + impuesto + " y el monto con el impuesto agregado es: " + totalBrutoConImpuesto;
